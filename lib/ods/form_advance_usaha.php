            ...
            action: function ( e, dt, node, config ) {
              ...
              $('.formModal<?php echo $formName ?>').html("<div class='form-group col-md-3'>\
                                    <label for='transkip_uplaod'>\
                                        ...
                                        <img src='assets/img/add-image2.png' style='width:60%'  class='data-usaha-img imgreg'/>\
                                        <br><span class='data-usaha-info'></span>\
                                    </label>\
                                    <input type='file' accept='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' class='form-control data-usaha-input' name='data-usaha_upload'/>\
                                ...
                                1. data_usaha.xlsx (excel yang harus di isi dengan data usaha)<br>\
                                2. data_referensi.xlsx (excel yang berisi data referensi, seperti id provinsi dan lain lain)<br>\
                                3. ketika data_usaha.xlsx sudah di isi, silakan di upload, dan click upload<br><br></span>\
                                <a href='./assets/upload/template_data_usaha.zip' class='btn btn-success'>Download Template Excel</a>");
              
              imageInit($(".data-usaha-img"), $(".data-usaha-input"), $(".data-usaha-info"));
...
$('.formSubmit').on('click', function(){
   ...
   $.ajax({
      method: "POST",
      url: "./lib/ods/save_data_advance_usaha.php",
