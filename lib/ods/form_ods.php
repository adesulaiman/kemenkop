        ...
        <div class="box">
            ...
            <div class="box-body">
              <form class="filterForm">
                <div class="row">
                   <?php
                   $qFilter = $adeQ->select("select * from core_filter
                                            where filter_name='data_usaha'
                                            and gropname='header'
                                            order by id");
...
$('.filterAdvCheck').click(function(){
    ...
    var table = $("#<?php echo $formName ?>").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        "url" : "./lib/ods/load_data_ods.php?t=<?php echo $formView ?>&f=<?php echo $f?>",
        "data" : function(data){
...
$('.actFilter2').on('click', function(){
  ...
  var notFil = ['0', ''];
  <?php
  $getValFil = $adeQ->select("select * from core_filter where filter_name='data_usaha'");
