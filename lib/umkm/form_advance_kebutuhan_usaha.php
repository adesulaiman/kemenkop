...
$('.filterAdvCheck').click(function(){
    ...
    var table = $("#<?php echo $formName ?>").DataTable({
      ...
      "serverSide": true,
      "ajax": {
        "url" : "./lib/umkm/load_data_ods_ktp.php?t=<?php echo $formView ?>&f=<?php echo $f?>",
        "type": "POST",
        "data" : function(data){
  ...
  $.ajax({
    ...
    success: function( msg ) {
        ...
        $.ajax({
          ...
          dataType: 'json',
          method: 'POST',
          data: 'formType=add&id_pemilik_usaha='+idPmilikUshaInit+'&f=<?php echo $f ?>',
          success: function(msg){
            if(!msg.status){
              $(".formModal<?php echo $formName ?> input").prop('disabled', true);
              $(".formModal<?php echo $formName ?> select").prop('disabled', true);
              $(".formModal<?php echo $formName ?> .id_pemilik_usaha").prop('disabled', false);
              $(".formModal<?php echo $formName ?> [name=formType]").prop('disabled', false);
              $(".infoValidateTlp ").html(msg.info);
            }
          },
          error: function(err){
            console.log(err);
        ...
        $(".id_pemilik_usaha").on("change", function(){
          $.ajax({
            ...
            dataType: 'json',
            method: 'POST',
            data: 'formType=add&id_pemilik_usaha='+$(this).val()+'&f=<?php echo $f ?>',
            success: function(msg){
              console.log(msg);
              if(!msg.status){
                $(".formModal<?php echo $formName ?> input").prop('disabled', true);
                ...
                $(".formModal<?php echo $formName ?> input").prop('disabled', false);
                $(".formModal<?php echo $formName ?> select").prop('disabled', false);
                $(".infoValidateTlp ").html(msg.info);
              }
            },
            error: function(err){
